        ...
        <div id="page">
            ...
            <div id="body">
                <div id="content">
                    ...
                    <form  action="bookCabReply1" method="post">
                        <table  border="0" cellspacing="20" cellpadding="8" style align="center">
                                ...
                                <td>
                                    <fieldset>
                                        ...
                                        <table cellpadding="5" cellspacing="5">
                                            ...
                                            <tr>
                                                <td class="text"><span style="color: red;">*</span>Cab Type:</td>
                                                <td> <input type= "text" size="25"  id="txtcabtype" name="txtcabtype" value="<%=a7%>"></td>
                                                <td class="text"><span style="color: red;">*</span>Email ID:</td>
                                                <td> <input type= "text" size="25"  id="emailid" name="emailid" value="<%=a8%>"></td>
                            ...
                            <tr>
                                <td>
                                    <fieldset>
                                        <legend>Rejection Information</legend>
                                        <table cellpadding="5" cellspacing="5">
                                            <tr>
                                                <td class="text"><span style="color: red;">*</span>Rejection&nbsp;:</td>
                                           <td> <input type= "text" size="25"  id="txtrej" name="txtrej" ></td>
