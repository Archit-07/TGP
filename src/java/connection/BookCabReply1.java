...
public class BookCabReply1 extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        a14 = request.getParameter("txtrej");
        if (a1 != null) {
            try {
                conn = connection.Connect.makeCon();
                String query = "Insert into bookcabreply(a1,a2,a3,a4,a5,a6,a7,a8,a9,a10,date,a11,a12,a13,a14)values(?,?,?,?,?,?,?,?,?,?,now(),?,?,?,?)";
